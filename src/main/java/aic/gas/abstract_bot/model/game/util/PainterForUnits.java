package aic.gas.abstract_bot.model.game.util;

import static aic.gas.abstract_bot.model.game.util.Annotator.paintCircle;
import static aic.gas.abstract_bot.model.game.util.Annotator.paintCircleFilled;
import static aic.gas.abstract_bot.model.game.util.Annotator.paintRectangleFilled;
import static aic.gas.abstract_bot.model.game.util.Annotator.paintText;
import static aic.gas.abstract_bot.model.game.util.Annotator.paintTextCentered;

import aic.gas.abstract_bot.model.game.wrappers.AUnitCommand;
import bwapi.Color;
import bwapi.Game;
import bwapi.Player;
